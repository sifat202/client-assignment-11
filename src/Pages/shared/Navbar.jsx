        ...
        {user ? (
            <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box p-3">
                    ...
                    <li className='btn h-12 w-37'>
                      <div className="flex items-center"><h1 className="text-md font-bold flex text-gray-800">H1 </h1><h1 className="text-md font-bold flex text-gray-800">👋 </h1><h1 className="text-md font-bold flex text-gray-800"> {user.displayName}</h1></div>
